...
public class TestPosition {
  ...
  public void postionOiseauAuDepart(){
   ...
   assertEquals(plateauModel.getOiseau().getPositionY(), Constante.Y_FRAME-(Constante.BIRD_BODY_RADIUS*3), 0); 
  }
  ...
  public void positionOiseauDansSaTrajectoire(){
    ...
    pointBezier.add(new Coordonnee(plateauModel.getOiseauPostion().getX(), plateauModel.getOiseauPostion().getY()));
    ...
    plateauModel.setOiseauPosition(plateauModel.getCourbe().calculerPoint(pointBezier, 0.2).getX(), plateauModel.getCourbe().calculerPoint(pointBezier, 0.2).getY());
